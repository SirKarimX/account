...
@section('content')
    <div class="row">
        {{ Form::model($adjustment, array('route' => array('stock-adjustment.update', $adjustment->id), 'method' => 'PUT','class'=>'w-100')) }}
        <div class="col-12">
        ...
        <div class="col-12">
            ...
            <div class="card repeater"  {{--data-value='{!! json_encode($adjustment) !!}'--}}>
                <div class="card-body py-0">
                    <div class="table-responsive">
                        <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                <td width="25%">{{ Form::select('item_id', $product_services,null, array('class' => 'form-control select2 item','data-url'=>route('invoice.product'),'required'=>'required')) }}</td>
                                <td>{{ Form::select('warehouse_id', $warehouses,null, array('class' => 'form-control select2','required'=>'required')) }}</td>
                                <td>
                                    <div class="form-group price-input">
                                        {{ Form::text('quantity',$adjustment->quantity, array('class' => 'form-control quantity','required'=>'required','placeholder'=>__('Qty'),'required'=>'required')) }}
