...
@section('content')
    <div class="row">
        {{ Form::open(array('url' => 'stock-transfer','class'=>'w-100')) }}
        <div class="col-12">
                ...
                <div class="card-body py-0">
                    <div class="table-responsive">
                        <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                <td width="25%">{{ Form::select('item_id', $product_services,'', array('class' => 'form-control select2','required'=>'required')) }}</td>
                                <td>{{ Form::select('from_warehouse_id', $warehouses,'', array('class' => 'form-control select2','required'=>'required')) }}</td>
                                <td>{{ Form::select('to_warehouse_id', $warehouses,'', array('class' => 'form-control select2','required'=>'required')) }}</td>
                                <td>
