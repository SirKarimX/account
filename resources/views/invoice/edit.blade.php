...
@section('content')
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr class="invoice_row">
                                ...
                                <td>
                                    {{ Form::select('warehouse_id', $warehouses,null, array('class' => 'form-control select2 warehouse')) }}
                                </td>
                                <td>
        ...
        <div class="col-12 text-right">
            <input type="submit" value="{{__('Update')}}" onclick="return check_for_negative_qty();"  class="btn-create btn-xs badge-blue radius-10px">
