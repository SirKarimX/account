            ...
            <div class="form-group">
                @if(!empty($permissions))
                    ...
                    <table class="table table-striped mb-0" id="dataTable-1">
                        ...
                        <tbody>
                        @php
                            $modules=['dashboard','user','role','warehouse','proposal','invoice','bill','revenue','payment','proposal product','invoice product','bill product','goal','bank account','transfer','transaction','product & service','customer','vender','constant tax','constant category','constant unit','constant custom field','company settings','assets','chart of account','journal entry','report'];
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        @endif
                                            ...
                                            @endif
                                        @endif
                                          @if(in_array('adj '.$module,(array) $permissions))
                                            @if($key = array_search('adj '.$module,$permissions))
                                                <div class="col-md-3 custom-control custom-checkbox">
                                                    {{Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'custom-control-input','id' =>'permission'.$key])}}
                                                    {{Form::label('permission'.$key,'Adj',['class'=>'custom-control-label'])}}<br>
                                                </div>
                                            @endif
                                        @endif
